...
const CLASS_COLORS = {
  ekmek_atiklari: '#D35400',  // Turuncu-kahve (ekmek rengi)
  kagit: '#2980B9',           // Mavi (kağıt/geri dönüşüm)
  organik_atik: '#27AE60',    // Yeşil (doğal/organik)
  plastik: '#8E44AD',         // Mor (plastik)
  yemek_artiklari: '#C0392B', // Kırmızı (yemek)
};

const CLASS_LABELS = {
  ekmek_atiklari: 'Ekmek Atıkları',
  kagit: 'Kağıt',
  organik_atik: 'Organik Atık',
  plastik: 'Plastik',
  yemek_artiklari: 'Yemek Artıkları',
};
...
export default function App() {
  ...
  if (!permission) return <View style={styles.center}><ActivityIndicator size="large" color="#2E7D32" /></View>;
  ...
  if (capturedImage) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <LinearGradient colors={['#1B5E20', '#2E7D32', '#388E3C']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.header}>
            ...
            <View style={styles.resultsSection}>
              {detections.length === 0 ? (
                <View style={styles.emptyResultCompact}>
                  ...
                  <Text style={styles.emptyTextSmall}>Tanınabilir atık bulunamadı</Text>
                </View>
              ) : (
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.home}>
        <Text style={styles.subtitle1}>♻️</Text>
        <Text style={styles.subtitle2}>RecyclEye</Text>
        <Text style={styles.subtitle}>Akıllı Atık Sınıflandırma</Text>
        <View style={styles.infoCard}>
          <Text style={styles.infoTitle}>Desteklenen Atık Türleri</Text>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#1B5E20', paddingVertical: scale(18), paddingHorizontal: scale(20), alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 4, elevation: 5 },
  ...
  subtitle1: { fontSize: scale(70), color: '#1B5E20', marginBottom: scale(1) }, 
  subtitle2: { fontSize: scale(30), color: '#1B5E20', marginBottom: scale(20), fontWeight: '700', letterSpacing: 0.7 },
  subtitle: { fontSize: scale(17), color: '#546E7A', marginBottom: scale(16), fontWeight: '500', letterSpacing: 0.5 }, // marginBottom azaltıldı
  infoCard: { backgroundColor: '#fff', borderRadius: scale(20), padding: scale(24), width: '100%', marginBottom: scale(20), shadowColor: '#1B5E20', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 12, elevation: 6 }, // marginBottom azaltıldı
  infoTitle: { fontSize: scale(18), fontWeight: '700', textAlign: 'center', marginBottom: scale(18), color: '#1B5E20' },
  ...
  primaryBtn: { backgroundColor: '#1B5E20', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: scale(18), paddingHorizontal: scale(24), borderRadius: scale(16), width: '100%', marginBottom: scale(12), shadowColor: '#1B5E20', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 5 }, // marginBottom azaltıldı
  primaryBtnText: { color: '#fff', fontSize: scale(18), fontWeight: '700', letterSpacing: 0.5 },
  secondaryBtn: { backgroundColor: '#fff', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: scale(18), paddingHorizontal: scale(24), borderRadius: scale(16), width: '100%', borderWidth: 2, borderColor: '#1B5E20', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  secondaryBtnText: { color: '#1B5E20', fontSize: scale(18), fontWeight: '700', letterSpacing: 0.5 },
  btn: { backgroundColor: '#1B5E20', paddingVertical: scale(16), paddingHorizontal: scale(32), borderRadius: scale(12), marginTop: scale(20), shadowColor: '#1B5E20', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.3, shadowRadius: 6, elevation: 4 },
  ...
  statusScanning: { backgroundColor: 'rgba(46, 204, 113, 0.95)' },
  ...
  captureBtnCore: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#fff', borderWidth: 3, borderColor: '#1B5E20' },
  ...
  summaryTitleSmall: { fontSize: scale(14), fontWeight: '700', color: '#1B5E20' },
  summarySubSmall: { fontSize: scale(12), color: '#558B2F', fontWeight: '600' },
