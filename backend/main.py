"""
RecycleEye - Object Detection API (ONNX Version)
...
app = FastAPI(
    title="RecycleEye API (ONNX)",
    description="Atik siniflandirma icin nesne tespit API'si - ONNX Runtime",
    version="2.0.0",
)
...
# Model siniflari
CLASS_NAMES = ["ekmek_atiklari", "kagit", "organik_atik", "plastik", "yemek_artiklari"]

# Sinif renkleri
CLASS_COLORS = {
    "ekmek_atiklari": "#D35400",
    "kagit": "#2980B9",
    "organik_atik": "#27AE60",
    "plastik": "#8E44AD",
    "yemek_artiklari": "#C0392B",
}

# Turkce sinif isimleri
CLASS_LABELS_TR = {
    "ekmek_atiklari": "Ekmek Atiklari",
    "kagit": "Kagit",
    "organik_atik": "Organik Atik",
    "plastik": "Plastik",
    "yemek_artiklari": "Yemek Artiklari",
}

# ONNX Model yolu
# recycleye_app/backend/main.py -> recycleye_app/backend -> recycleye_app (root)
ROOT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
MODEL_PATH = os.path.join(ROOT_DIR, "recycleye_model", "run", "weights", "best.onnx")
...
async def root():
    ...
    return {
        "status": "active",
        "message": "RecycleEye ONNX API calisiyor",
        "version": "2.0.0",
